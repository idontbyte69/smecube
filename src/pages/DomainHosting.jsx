...
const hostingPlans = [
  ...
  { title: '১ বছর / 2GB', features: ['ডোমেইন নাম', 'আনলিমিটেড ওয়েবসাইট', 'আনমিটার্ড SSD', 'আনলিমিটেড মেইলবক্স', 'অটো ব্যাকআপ', 'AI ওয়েবসাইট বিল্ডার', 'AI টুলস'], price: '৳ ২,৫০০/বছর', popular: true },
  { title: '১ বছর / 3GB', features: ['ডোমেইন নাম', 'আনলিমিটেড ওয়েবসাইট', 'আনমিটার্ড SSD', 'আনলিমিটেড মেইলবক্স', 'অটো ব্যাকআপ', 'AI ওয়েবসাইট বিল্ডার', 'AI টুলস'], price: '৳ ৩,০০০/বছর' },
  { title: '১ বছর / 4GB', features: ['ডোমেইন নাম', 'আনলিমিটেড ওয়েবসাইট', 'আনমিটার্ড SSD', 'আনলিমিটেড মেইলবক্স', 'অটো ব্যাকআপ', 'AI ওয়েবসাইট বিল্ডার', 'AI টুলস'], price: '৳ ৩,৫০০/বছর' },
  { title: '১ বছর / 5GB', features: ['ডোমেইন নাম', 'আনলিমিটেড ওয়েবসাইট', 'আনমিটার্ড SSD', 'আনলিমিটেড মেইলবক্স', 'অটো ব্যাকআপ', 'AI ওয়েবসাইট বিল্ডার', 'AI টুলস'], price: '৳ ৪,০০০/বছর' },
  { title: '১ বছর / 6GB', features: ['ডোমেইন নাম', 'আনলিমিটেড ওয়েবসাইট', 'আনমিটার্ড SSD', 'আনলিমিটেড মেইলবক্স', 'অটো ব্যাকআপ', 'AI ওয়েবসাইট বিল্ডার', 'AI টুলস'], price: '৳ ৪,৫০০/বছর' },
]
...
export default function DomainHosting() {
  ...
  async function checkRDAP(domain) {
    try {
      const res = await fetch(`https://rdap.org/domain/${encodeURIComponent(domain)}`, { method: 'GET' })
      ...
      <section className="bg-[var(--brand-bg)] py-12 md:py-12">
        <div className="container-max text-center">
          ...
          <p className="mt-4 text-lg md:text-xl max-w-3xl mx-auto">
            SME CUBE — আপনার ব্যবসার ডিজিটাল সহযাত্রী। ক্ষুদ্র ও মাঝারি উদ্যোক্তাদের জন্য আধুনিক, সাশ্রয়ী এবং কার্যকর প্রযুক্তি সমাধনা এক প্ল্যাটফর্মে।
          </p>
        </div>
      </section>
        ...
        <div className="container-max">
          <div className="max-w-2xl mx-auto grid grid-cols-2 gap-6">
            ...
            >
              ...
              <h2 className="text-2xl font-bold">হোস্টিং</h2>
            </button>
          </div>
        </div>
      </section>
          ...
          <div className="container-max">
            ...
            <div className="mt-8 grid md:grid-cols-2 lg:grid-cols-3 gap-6">
              {hostingPlans.map((p, i) => (
                <div key={i} className={`rounded-xl bg-white shadow-soft p-6 border ${p.popular ? 'border-[var(--brand-accent)]' : 'border-slate-100'}`}>
                  {p.popular && (
                    <div className="text-xs uppercase tracking-wider inline-block mb-3 px-3 py-1 rounded-full bg-[var(--brand-accent)] text-white">সবচেয়ে জনপ্রিয়</div>
                  )}
                  ...
                  <div className="flex items-center justify-between">
                    <div className="text-2xl font-extrabold text-[var(--brand-accent)]">{p.price}</div>
                    <a href="https://my.smecube.com/authentication/login" className="btn-primary">ক্রয় করুন</a>
                  </div>
                </div>
              ))}
            </div>
          ...
          <div className="container-max">
            <div className="bg-white rounded-xl shadow-soft p-6 md:p-8">
              ...
              <div className="mt-6 max-w-2xl mx-auto">
                ...
                <p className="mt-2 text-sm text-slate-600">যে TLD গুলো আমরা চেক করবো: {TLDs.join(', ')}</p>
              ...
              {results.length > 0 && (
                <div className="mt-6 max-w-3xl mx-auto">
                  <ul className="divide-y rounded-lg border border-slate-200 overflow-hidden">
                    {results.map((r) => (
                      <li key={r.domain} className="flex items-center justify-between p-4 bg-white">
                        <div className="flex items-center gap-3">
                          <span className="font-medium">{r.domain}</span>
                          {r.status === 'available' && <span className="text-xs px-2 py-1 rounded bg-green-100 text-green-700">উপলব্ধ</span>}
                          {r.status === 'registered' && <span className="text-xs px-2 py-1 rounded bg-slate-100 text-slate-700">রেজিস্টার্ড</span>}
                          {r.status === 'unknown' && <span className="text-xs px-2 py-1 rounded bg-amber-100 text-amber-800">অজানা</span>}
                        </div>
                        <div>
                          {r.status === 'available' ? (
                             <a href="https://my.smecube.com/authentication/login" className="btn-primary">ক্রয় করুন</a>
                          ) : (
                            <button className="inline-flex items-center justify-center px-4 py-2 rounded-lg border border-slate-300 text-slate-700 font-medium">ডিটেইলস</button>
                          )}
                        </div>
                      </li>
                    ))}
      ...
      <section className="py-10 md:py-12">
        <div className="container-max">
          <div className="bg-white rounded-xl shadow-soft p-6 md:p-8 text-center">
            <h3 className="text-2xl md:text-3xl font-bold">আপনার ব্যবসার জন্য সঠিক ডোমেইন ও হোস্টিং প্যাকেজ চাই?</h3>
            <p className="mt-2">আমাদের বিশেষজ্ঞ টিম আপনার বাজেট ও প্রয়োজন অনুযায়ী সেরা সমাধান সাজিয়ে দেবে।</p>
            <a className="btn-primary mt-5 inline-flex" href="#contact">ফ্রি কনসালটেশন নিন</a>
          </div>
        </div>
      </section>
    </div>
